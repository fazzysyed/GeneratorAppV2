...
const CustomerDashboard = ({navigation}) => {
  ...
  const getServices = () => {
    ...
    fetch(
      `https://zacharydevworks.com/generator_app_backend/api/complete-service-call?user_id=${user.user.id}`,
      requestOptions,
    )
    ...
    // var config = {
    //   method: 'post',
    //   url: 'https://zacharydevworks.com/generator_app_backend/api/customer-call-service',
    //   headers: {
  ...
  const requestService = () => {
    ...
    var config = {
      method: 'get',
      url: `https://zacharydevworks.com/generator_app_backend/api/service-call-request/${user.user.id}`,
      headers: {
        Accept: 'application/json',
        Authorization: `Bearer ${user.access_token}`,
      },
